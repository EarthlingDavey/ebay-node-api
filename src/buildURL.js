...
const buildURL = {
  ...
  buildSearchUrl(options) {
    ...
    baseUrl += options.outputSelectors
      ? 'hi'
      : '&outputSelector(0)=SellerInfo&outputSelector(1)=PictureURLLarge&outputSelector(2)=PictureURLSuperSize&outputSelector(3)=GalleryInfo';
